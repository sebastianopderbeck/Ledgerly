import type { ParsedAutoCoupon, ExtractedPdf, PdfMeta } from "@ledgerly/shared";
...
export async function parseAutoCoupon(data: Uint8Array, extracted?: ExtractedPdf): Promise<{ coupon: ParsedAutoCoupon; meta: PdfMeta }> {
